        ...
        {isLoading && <Loader/>}
            <div className='bg-gray-800 flex flex-col justify-center'>
                <form className='max-w-[1000px] w-full mx-auto bg-gray-900 p-8 m-5 rounded-lg'>
                    <h2 className='text-4xl dark:text-white font-bold text-center'>Edit Profile</h2>
                    <div className="form-group">      
                        ...
                        <code className="m-auto">Click on the image to change.</code>
                    </div>
                    <div className='form-group'>
                    ...
                    <div className='form-group'>
                        <label>Phone</label>
                        <input className='form-control' type="text" name="name" onChange={handleInputChange} value={profile?.phone} required/>
                    </div>
                    <div className='form-group'>
                        <label>Bio</label>
                        <textarea className='form-control' type="password" name="bio" onChange={handleInputChange} value={profile?.bio}/>
                    </div>
                    <button type="button" onClick={saveProfile} className='btn-primary'>Edit Profile</button> 
                </form>
            </div>
    </div>
  )
